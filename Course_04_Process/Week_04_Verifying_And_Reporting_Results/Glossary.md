...
* **COALESCE**: A SQL function that can be used to return non-null values in a list
...
* **Incomplete data**: A data that is missing important fields
* **Inconsistent data**: A data that uses different formats to represent the same thing
* **Incorrect/inaccurate data**: A data that is complete but inaccurate
